...
class Admin_model
{
    ...
    public function addClass($nama_kelas, $dosen_id, $waktu_mulai, $waktu_selesai, $hari)
    {
        $this->db->query("INSERT INTO class (nama_kelas, dosen_id, waktu_mulai, waktu_selesai, hari) VALUES (:nama_kelas, :dosen_id, :waktu_mulai, :waktu_selesai, :hari)");
    ...
    public function updateClass($id, $nama_kelas, $dosen_id, $waktu_mulai, $waktu_selesai, $hari)
    {
        $this->db->query("UPDATE class SET nama_kelas = :nama_kelas, dosen_id = :dosen_id, waktu_mulai = :waktu_mulai, waktu_selesai = :waktu_selesai, hari = :hari WHERE id = :id");
        $this->db->bind(':id', $id);
        $this->db->bind(':nama_kelas', $nama_kelas);
        $this->db->bind(':dosen_id', $dosen_id);
        $this->db->bind(':waktu_mulai', $waktu_mulai);
